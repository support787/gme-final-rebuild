...
export const Footer = () => {
  const dotmedProfileUrl = 'https://www.dotmed.com/'; 
  const dotmedWebstoreUrl = 'https://www.dotmed.com/webstore/102949/';
        ...
        <div className="container mx-auto px-6 grid grid-cols-1 md:grid-cols-4 gap-8 text-left">
            ...
            <div>
                ...
                <address className="text-gray-400 text-sm not-italic space-y-2">
                    ...
                    <p><strong>Phone:</strong> +1 (888) 519-2888</p>
            ...
            <div>
                ...
                <div className="space-y-4">
                                        {/* --- NEW WEBSTORE LINK ADDED --- */}
                    <a href={dotmedWebstoreUrl} target="_blank" rel="noopener noreferrer">
                        <img 
                            src="https://images.dotmed.com/images/webstore/DOTmedWebStore.gif"
                            alt="See my DOTmed Webstore"
                            title="My Webstore: Grand Medical Equipment, Inc."
                            style={{ border: 0 }}
